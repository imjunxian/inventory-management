 ...
 <?php
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Recycle Bin - Suppliers</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-12">
          ...
          <div class="card">
            <form action="">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <?php
                  $sta = "Inactive";
                  $query = $connection -> prepare("SELECT * FROM suppliers WHERE supplierStatus=?");
                      ...
                      ?>
                          <tr>
                            ...
                            <td style="text-align:center;">
                              <form action="../suppliers/code.php" method="post">
                                <div class="btn">
                                  <input type="hidden" name="recover_id" value="<?php echo $row['supplierId']; ?>">
                                  <button type="submit" name="recoverBtn" class="btn btn-primary" data-toggle="tooltip" title="Recover <?php echo $row["supplierName"]; ?>"><i class="fa fa-undo" style="font-size:14px;"></i></button>
                                  <input type="hidden" name="delete_id" value="<?php echo $row['supplierId']; ?>">
                                  <!--<a href="#deleteModal" class="btn btn-danger deleteBtn" data-id="<?php echo $row['supplierId']; ?>" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash" data-toggle="tooltip" title="Delete <?php echo $row["supplierName"]; ?>"></i></a>-->
                                </div>
            ...
            <div class="card-footer">
                        <a class="btn btn-secondary" href="../suppliers/">View</a>
                    </div>
          </div>
          <!-- /.card -->
        </div>
