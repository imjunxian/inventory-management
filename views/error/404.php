...
<div class="container">
        <div class="error">
            <h1>404</h1>
            <h2>Error</h2>
            <p>Oops! Page Not Found :(<br>
            <!--Please <a href="javascript:history.go(-1)">CLICK HERE</a> to Go Back</p>-->
            <a href="javascript:history.go(-1)" class="btn btn-dark" style="margin-top: 3%;">Back to Previous Page</a>
            </p>
        </div>
