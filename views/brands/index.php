            ...
            <form action="code.php" id="addF" method="post" >
              <div class="modal-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter Brand Name" name="brandName" required>
                </div>
          ...
          <div class="col-12">
            ...
            <div class="card">
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                  <form action="code.php" method="post">
                                    <div class="btn">
                                    <input type="hidden" name="edit_id" value="<?php  echo $row['brandId']; ?>">
                                      <button type="submit" name="editBtn" class="btn btn-primary" data-toggle="tooltip" title="Edit <?php echo $row["brandName"]; ?>"><i class="fa fa-pencil-alt" style="font-size:14px;"></i></button>
                                      <input type="hidden" name="delete_id" value="<?php  echo $row['brandId']; ?>">
                                      <a href="#deleteModal" class="btn btn-danger deleteBtn"
                                      data-id="<?php  echo $row['brandId']; ?>" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash" data-toggle="tooltip" title="Remove <?php echo $row["brandName"]; ?>"></i></a>
                                    </div>
              ...
              <div class="card-footer">
                        <a class="btn btn-secondary" href="../recycle/brands.php"><i class="fa fa-recycle"></i> Recycle Bin</a>
                    </div>
            </div>
            <!-- /.card -->
          </div>
