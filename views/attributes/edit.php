            ...
            <div class="card card-default">
              ...
              <?php
                ...
                if(isset($_SESSION['editid'])){
                    ...
                    ?>
                        ...
                        <input type="hidden" class="form-control" id="userid" value="<?php echo $row['attributeId']?>" placeholder="id" name="attid">

                        <div class="form-group">
                            <label> Attribute Name </label>
                            <input type="text" class="form-control" placeholder="Enter Attribute Name" name="attName" value="<?php echo $row['attributeName'];?>">
                        </div>
              ...
              <!--<br>
                <p class="text-justify text-center">
                  ...
                  You may <a href="../attributes/">CLICK HERE</a> to return.
                </p>
              <br>-->
              <script> location.replace("../attributes/index.php?idnotfound"); </script>
              <?php
            }
