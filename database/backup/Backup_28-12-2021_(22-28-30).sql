...
INSERT INTO products (productId, productSKU, productName, productImage, productQuantity, productPrice, productCost, productDescription, brandId, categoryId, attvalueId, supplierId, availability, status, addDate) VALUES ('2','BLCG1','Recycled Sneakers','balenciaga1.jpg','6','2399','2100','<p>Balenciaga Recycled Sneakers</p>','3','["1","2"]','["1","6","8"]','["1"]','Available','Active','2021-12-11 15:24:11');
...
INSERT INTO users (userId, userName, userEmail, userContact, userGender, userBirthDate, userRoles, userPassword, status, lastLogin, currentStatus, profileImg) VALUES ('4','demo3','demo3@demo.com','0126788122','Female','1999-11-24','Staff','$2y$10$VE/zH2tOyGdGpHKpEnCFWOVTAf81k2I4yb1P4LTvSGL11HeCzee9m','Active','Sat 17:29:31 25/12/2021','Offline','jisoo.jpg');
